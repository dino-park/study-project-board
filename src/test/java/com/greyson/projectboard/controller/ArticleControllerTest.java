...
import com.greyson.projectboard.service.PaginationService;
import com.greyson.projectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @Test
    void givenSearchKeyword_whenSearchingArticleView_thenReturnsArticleView() throws Exception {
        // Given
    ...
    @WithUserDetails(value = "dinoTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
