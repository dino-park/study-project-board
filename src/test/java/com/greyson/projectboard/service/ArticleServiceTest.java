...
class ArticleServiceTest {
    ...
    @DisplayName("검색어 입력 후 게시글 검색 시, 게시글 페이지 반환")
    @Test
    ...
    void givenArticleId_whenSearchingArticlewithComments_thenReturnsArticleWithComments() {
        ...
        assertThat(dto)
                ...
                .hasFieldOrPropertyWithValue("hastagDtos", article.getHashtags().stream()
                        .map(HashtagDto::from)
    ...
    @DisplayName("해시태그 조회 시, 유니크 해시태그 리스트를 반환")
    @Test
    ...
    @DisplayName("게시글 정보 입력 시, 게시글 생성 및 저장")
    @Test
    ...
    @DisplayName("게시글의 수정내용 입력 시, 게시글 수정")
    @Test
    ...
    @DisplayName("게시글의 ID 입력 시, 게시글 삭제")
    @Test
